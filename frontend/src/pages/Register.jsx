    ...
    <div className="w-full max-w-xl mx-auto">
      ...
      <div className="space-y-4">
        ...
        <Link 
          ...
          className="group block w-full p-6 bg-white border-2 border-slate-100 hover:border-violet-500 rounded-2xl transition-all shadow-sm hover:shadow-md"
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-slate-900">I am a Laboratory Admin</h3>
                <p className="text-sm text-slate-500 mt-1">Process diagnostic tests and manage samples</p>
              </div>
            </div>
            <ArrowRight className="text-slate-300 group-hover:text-violet-500 transition-colors" />
          </div>
        </Link>
      </div>
